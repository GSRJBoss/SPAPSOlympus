...
/**
 * Entity implementation class for Entity: GrupoSanguineo
 *
 */
@Entity
@Table(name = "grupo_sanguineo", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = "id"))
public class GrupoSanguineo implements Serializable {
	...
	public boolean equals(Object obj) {
		if (obj == null) {
			...
			if (!(obj instanceof GrupoSanguineo)) {
				return false;
			} else {
				if (((GrupoSanguineo) obj).id == this.id) {
					return true;
				} else {
					return false;
				}
